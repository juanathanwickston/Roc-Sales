// ===== ROC ACADEMY v3 â CONTENT DATA =====

// âââ FEATURE FACTORY â Product Knowledge Arcade âââ
const PRODUCT_BINS = [
 {label:'ROC Giving', icon:'ð', color:'#a78bfa'},
 {label:'ROC Services', icon:'ð§', color:'#60a5fa'},
 {label:'Terminal+', icon:'ð³', color:'#34d399'},
 {label:'RewardPay', icon:'ð°', color:'#fbbf24'}
];
const FEATURES = [
 ...
 {text:'EstimateâInvoice', product:1},
...
// SALES FLOOR â 6-Stage Payroc Sales Process
// 1. Identify the Customer â 2. Ask for Appointment â 3. Prep for Appointment
// 4. Make the Sale â 5. Close the Sale â 6. Ask for Referrals
const FLOOR=[
{name:"Mike Reynolds",type:"General Contractor â6 Techs",avi:"ð§",steps:[
 ...
 opts:[
 {txt:"Check his processing volume potential â 6 techs doing $2-5K in jobs weekly = $50-120K/month through field invoicing. He has pain (paper invoicing) AND volume. That's a qualified lead.",ok:2,fb:"You quantified the opportunity AND identified the pain signal before picking up the phone. Identifying the customer means confirming BOTH fit and pain â not just that they exist."},
 {txt:"Look him up on Google and check his reviews to see if his business is legit. If he has good reviews and a real website, he's worth calling because he's a serious business owner.",ok:0,fb:"Reviews tell you he's legit â but you already knew that. Identification means qualifying: Does he have volume? Does he have pain? Can you solve it? Google reviews don't answer any of those."},
 {txt:"Add him to your call list since he's a contractor with multiple techs â that's a solid profile. The more calls you make to businesses like his, the more appointments you'll generate.",ok:1,fb:"He fits the profile, but you didn't validate the pain or estimate the opportunity size. 'Spray and pray' calling is activity without intelligence. Identify means QUALIFY first."}]},
 ...
 {txt:"Absolutely, I can send you some info. But before I do â what's the biggest headache with your current payment setup? That way I send you the right stuff instead of a generic brochure.",ok:1,fb:"Better â you're trying to keep the conversation going. But you still accepted the 'email me' frame. The goal is to pivot to a scheduled meeting, not a better email."}]},
 ...
 {tag:"4. MAKE THE SALE",q:"You're in Mike's office. He says: \"Alright, show me what you got. But make it quick â I've got a crew waiting on materials.\"",
 opts:[
 {txt:"Here's the play: your tech finishes a job, pulls out their phone, invoices the customer right there, customer pays before they leave â and it's in your QuickBooks by dinner. No more 2-week invoice chase. Let me show you exactly how it works.",ok:2,fb:"You led with the OUTCOME, not the feature list. Mike doesn't care about 'mobile invoicing and QuickBooks sync' â he cares about getting paid faster. Paint the picture, then demo."},
 ...
 {txt:"Before I show you anything â walk me through exactly what happens when a tech finishes a job right now. I want to make sure what I show you actually matches how your guys work in the field.",ok:1,fb:"Discovery is important, but you already did this in your prep and your first call. He gave you 15 minutes and said 'make it quick.' It's time to deliver the solution, not re-discover."}]},
 {tag:"5. CLOSE",q:"Mike is nodding: \"This looks solid. But let me think about it â I need to run it by my bookkeeper before I commit to anything.\"",
 opts:[
 ...
 opts:[
 {txt:"Mike, I appreciate the trust. You mentioned you know other contractors in the area â who else is still dealing with the same paper invoice headache you had? I'd love to help them the same way, and I'll make sure you're taken care of for the intro.",ok:2,fb:"You asked while the emotional high is fresh, framed it around HIS pain (so it's relatable), and made it easy to say yes. This is when referrals are warmest â never wait."},
 {txt:"I'll make sure your installation goes perfectly, and once your team has been using it for a month or two, I'd love to ask if you know anyone else who might benefit. Happy customers are the best referrals.",ok:0,fb:"A month from now, the emotional high is gone. He's busy, he forgot how bad paper invoicing was. Ask NOW â right after the 'this is exactly what we needed' moment. Timing is everything."},
 {txt:"Before I head out â do you mind if I leave a few business cards? If anyone you know mentions payment headaches, just pass one along and have them give me a call whenever works for them.",ok:1,fb:"Passive referral. Business cards sit in drawers. A direct ask â 'who else do you know dealing with this?' â converts 10x higher than 'pass along my card if you think of someone.'"}]}
]},
{name:"Sarah Chen",type:"CafÃ© Owner â200+ Daily Txns",avi:"â",steps:[
 {tag:"1. IDENTIFY",q:"Sarah Chen owns a busy cafÃ© doing 200+ daily transactions. She's currently on Clover. What signals tell you she's worth pursuing NOW vs. later?",
 opts:[
 {txt:"She's on Clover â known for reseller support problems and proprietary hardware lock-in. At 200+ daily txns, she's paying serious processing fees. If she's had any support issues, she's already frustrated and ready to listen.",ok:2,fb:"You identified two pain signals: platform risk (Clover support) and fee exposure (volume). The 'identify' stage is about finding merchants with ACTIVE pain, not just any merchant who processes cards."},
 {txt:"200+ daily transactions is high volume, which means a good-sized deal for your pipeline. CafÃ© owners are also generally accessible â you can walk in during off-hours and have a real conversation easily.",ok:1,fb:"Volume is good, but that's deal SIZE, not urgency. What makes her worth calling NOW? Active platform pain. Without a pain trigger, she's a future prospect, not a current one."},
 {txt:"She's a cafÃ© owner in your territory, so she qualifies as a local small business that could benefit from our services. Add her to your prospect list and schedule a drop-in next week.",ok:0,fb:"'She's a business that takes cards' isn't identification â it's a phone book. The identify stage means qualifying: What's her pain? Why now? What product fits? Go deeper before burning time."}]},
 {tag:"2. APPOINTMENT",q:"You walk into Sarah's cafÃ© during a 3pm lull. She's wiping tables. You introduce yourself. She says: \"Another payment sales guy? I already have Clover and I'm not interested in switching right now.\"",
 opts:[
 {txt:"Fair enough â I'm not here to sell you anything today. Quick question though: when your Clover system crashed during a lunch rush, how long did it take support to actually fix it? Because that's the one thing I hear from every cafÃ© owner on Clover.",ok:2,fb:"You disarmed the resistance, asked a pain-trigger question, and demonstrated industry knowledge. If she's had a crash (and at 200+ daily, she has), you just opened a real conversation."},
 {txt:"I totally understand â switching is a hassle. But what if I told you I could save you 30-40% on your processing fees without changing anything about your day-to-day operations? Would that be worth a conversation?",ok:1,fb:"Leading with savings is tempting, but '30-40%' is a generic claim she's heard before. The pain-trigger question (crashes, support) creates an emotional response. Savings are logical â pain is emotional."},
 {txt:"No problem at all, Sarah. Here's my card â if you ever get frustrated with Clover or want to explore other options, give me a call. I'm in the area every week and I'd love to earn your business.",ok:0,fb:"You left a card with someone who just told you she's not interested. That card goes in the trash. The appointment stage means creating a reason to meet â not accepting rejection politely."}]},
 ...
 opts:[
 {txt:"Three things that change: One â the X800 handles your lunch rush without crashing, and when something does go wrong, you call us directly, not a reseller maze. Two â your $4K in monthly fees drops to near-zero with ConsumerChoice. Three â your staff trains in one shift. Want to see it live?",ok:2,fb:"Three problems, three solutions, zero fluff. Each one maps to a pain she told you about. You demonstrated you listened, you quantified the value, and you offered to prove it. That's making the sale."},
 {txt:"Let me start by showing you the X800 interface â it's really intuitive. You've got bill splitting here, tip management here, and NFC tap right here for Apple Pay. The whole system runs on our cloud platform with 99.9% uptime.",ok:1,fb:"Feature tour. She didn't ask HOW the POS works â she asked WHY she should switch. Lead with the answer to HER question (reliability, savings, support), then demo the features that prove it."},
 {txt:"Before I show you the hardware, let me walk through the economics. At $4K/month in processing, you're spending $48K per year on fees alone. With our ConsumerChoice program, we can bring that to virtually zero.",ok:1,fb:"Good lead on savings, but you only addressed 1 of 3 pain points. She's frustrated about crashes and support too â the money alone might not be enough to overcome switching fear. Address ALL three."}]},
...
{name:"Pastor Williams",type:"Church â800-Member Congregation",avi:"âª",steps:[
 ...
 opts:[
 {txt:"Research their giving setup â if they're on Tithe.ly or Planning Center at 2.9%+30Â cents, and only 15-20% give online, there's a double pain: high fees AND low digital adoption. With 800 members, that's a $100K+ giving potential with significant fee waste.",ok:2,fb:"You quantified BOTH sides of the pain: fee leakage and participation gap. That's a qualified opportunity with a clear value proposition. Now you've earned the right to pick up the phone."},
 ...
 {txt:"800 members is a solid-sized congregation â most churches that size process $120K+ in annual giving. That's enough volume to make this worth pursuing. Add them to your pipeline and call the church office.",ok:1,fb:"Volume potential is right, but you didn't identify the PAIN. Why would they switch? What's broken? 'They're big enough' isn't a pain signal â it's a size check. Dig deeper before calling."}]},
 ...
 opts:[
 {txt:"I hear you â Tithe.ly is solid for basic online giving. Quick question: what percentage of your congregation actually gives digitally right now? Because most churches your size tell me it's under 20%, and that gap usually means there's significant giving you're not capturing.",ok:2,fb:"You validated his choice, then asked a diagnostic question he probably can't answer confidently. If the answer is low (it almost always is), you just created curiosity about a problem he didn't know he had."},
 {txt:"Totally understand, Pastor. A lot of churches are happy with Tithe.ly until they see how much they're paying in processing fees. At 2.9% plus 30per donation, a church your size is losing $3,500-4,000 a year in fees alone.",ok:1,fb:"Fee math is compelling, but you led with money to a pastor. Churches are mission-driven â lead with PARTICIPATION ('are you reaching all your givers?'), then follow with fees as the second reason."},
 {txt:"No problem at all â I don't want to disrupt something that's working. If you ever want a second opinion or if Tithe.ly raises their rates, keep my name handy. I work with a lot of churches in the area and I'm always happy to help.",ok:0,fb:"You accepted 'happy with Tithe.ly' at face value and walked away. 'Works fine' often means 'I haven't seen better.' Your job is to create awareness of a problem â not agree that everything's great."}]},
 ...
 opts:[
 {txt:"Build around his 12% number: model what happens if Text-to-Give lifts online participation to 35-40%. Calculate his current Tithe.ly fee drain on annual giving. Prep a live Text-to-Give demo he can try himself. Have a ROC Terminal+ recommendation ready for events.",ok:2,fb:"Every prep element maps to HIS data point (12%) and HIS pain. You're not pitching generically â you're showing him exactly what his church is leaving on the table with hard numbers."},
 {txt:"Prepare the standard ROC Giving demo with Text-to-Give, QR codes, and campaign pages. Bring testimonials from other churches that switched from Tithe.ly. Have the fee comparison sheet showing ROC Giving vs. Tithe.ly pricing side by side.",ok:1,fb:"Generic materials. He gave you the 12% data point â use it. Show HIM what 12% vs. 40% adoption means in HIS giving numbers. Personalized prep closes; brochure prep educates."},
 ...
 opts:[
 {txt:"Let me show you what 12% vs. 40% means for your church. If your average member gives $150/month and you move from 12% to 40% digital adoption with Text-to-Give, that's an additional $33,600 in captured giving per year â plus fee offset keeps that $4,200 you're paying Tithe.ly in your ministry budget.",ok:2,fb:"You used HIS numbers to paint a specific, dollar-denominated picture. He can see two things: more giving captured AND fees recovered. That's not 'better than Tithe.ly' â that's a completely different outcome."},
 {txt:"I don't need to be better than Tithe.ly â I just need to solve the problem Tithe.ly can't: participation. Text-to-Give lets any member give in 10 seconds with no app, no login. That's why our churches see 3x the digital adoption rates.",ok:1,fb:"Good positioning, but 'our churches see 3x' is a generic claim. Use HIS 12% number to make it personal. '12% to 40% means $33K more for your ministry' hits harder than '3x adoption rates.'"},
 ...
 {txt:"I can send you a comprehensive proposal document with our pricing, implementation timeline, migration plan, and church testimonials. That should give the board everything they need to make an informed decision.",ok:1,fb:"A PDF isn't a partner. Boards ask questions that documents can't answer. Your job is to prep the pastor to CHAMPION this â that means working through the board's likely objections together, not emailing a packet."},
 {txt:"That's great news that it's going to the board. In my experience, church boards usually take a couple of weeks to make these decisions. Let's plan to reconnect after the meeting and I'll be available for any follow-up questions they have.",ok:0,fb:"Passive follow-up on an institutional sale = dead deal. Board members will raise objections the pastor can't answer, and the deal stalls. Stay in the process â help prep the presentation."}]},
 ...
 opts:[
 {txt:"Pastor, that means a lot. You're connected with other church leaders in the area â who else is dealing with the same participation gap you discovered? I'd love to help them see what you saw, and a warm introduction from you would mean the world.",ok:2,fb:"Direct, specific, and framed around the pain he experienced personally. 'The participation gap you discovered' makes it about helping other pastors, not about your sales quota. This generates the warmest intros."},
 {txt:"Thank you, Pastor. Would you be open to me mentioning your church when I talk to other congregations in the area? Having a local reference church makes a huge difference when other pastors are evaluating their giving platforms.",ok:1,fb:"Reference â  referral. A reference is passive (someone calls to verify). A referral is active (he introduces you). Ask for introductions, not permission to name-drop."},
 {txt:"I'd love to share your story â once you've been on the platform for a quarter and have real giving data to show, would you be willing to do a short video testimonial? That kind of social proof is incredibly powerful for other churches.",ok:0,fb:"A testimonial in 3 months doesn't help you TODAY. The emotional high is RIGHT NOW. Ask for the referral while he's saying 'this is going to transform our giving' â not after he's forgotten how bad Tithe.ly was."}]}
]}];

// OBJECTION BLITZ â All answers are substantial and plausible
const BLITZ=[
{q:"\"Square is free to start. Why would I switch to something that costs money?\"",
 opts:[
 {txt:"Square charges 2.6% + 15Âon every single swipe with no way to reduce it. Pull your last three statements â I'll show you exactly what 'free' is actually costing you, and how RewardPay Choice brings that to zero.",ok:true},
 ...
 {txt:"The difference is the level of service. Square is completely self-serve â no dedicated rep, no phone support. With Payroc, you get a named account manager who knows your business personally.",ok:false}],
 bc:"Never compete on 'free.' Compete on COST. Square's 2.6%+15Âwith no offset = expensive. RewardPay Choice = 0% effective. Always do the math on their statements."},
{q:"\"We're locked into a two-year contract with our current processor. There's nothing I can do.\"",
 ...
 {txt:"A lot of those contracts actually have a 30-day cancellation window each year around your anniversary date. Let me look at your agreement â there might be an exit you don't know about.",ok:false},
 {txt:"I completely understand â contracts are contracts. Let's get everything set up now and schedule the switch for when your current agreement expires so there's zero downtime or overlap.",ok:false},
...
{q:"\"I don't want to charge my customers extra. Surcharging will drive people to my competitor down the street.\"",
 opts:[
 {txt:"That's exactly why we do ConsumerChoice, not surcharging. It's dual pricing â customers see a cash price and a card price, clear as day. No surprises. 80% of my merchants use it and I've never had one switch back.",ok:true},
 ...
 bc:"ConsumerChoice â  surcharging. It's transparent dual pricing. Key stat: 80%+ merchant adoption, near-zero reported customer complaints. Social proof closes this objection."},
{q:"\"Your competitor offered us interchange-plus at cost with a $15 monthly fee. Why should I pay more for Payroc?\"",
 opts:[
 {txt:"What's the total? Interchange-plus 'at cost' usually hides statement fees, PCI fees, batch fees, and annual fees that add $50-$100/month. Compare TOTAL cost â and ask them if they offer RewardPay Choice at 0%.",ok:true},
 ...
 {txt:"That sounds like a loss-leader offer â they're pricing below margin to win your business and then they'll raise rates in 6-12 months once you're locked in. We see it all the time with our competitors.",ok:false},
 {txt:"I'd want to see that quote in writing. A lot of reps quote rates verbally that don't match the actual contract terms. We're always transparent about our pricing from day one â no bait and switch.",ok:false}],
...
{q:"\"I need to think about it and discuss with my business partner before we move forward on anything.\"",
 opts:[
 {txt:"Absolutely â what specifically do you want to talk through with your partner? Let me put together a one-page savings comparison they can review. What questions do you think they'll have so I can address them upfront?",ok:true},
 ...
 {txt:"Before you go â let me leave you with this: every month you stay on your current setup, you're paying $X in fees you don't have to pay. The sooner we move, the sooner those savings start.",ok:false},
...
{q:"\"We process $3K a month â we're too small for this to matter. The fees are just cost of doing business.\"",
 opts:[
 {txt:"At $3K/month on Square, that's $1,000+ per year going to processing fees. RewardPay Choice takes that to zero regardless of your volume. I had a merchant your exact size save $900 in the first year â and he asked why he didn't switch sooner.",ok:true},
 ...
 bc:"Do the math at THEIR volume â even $3K/month = $1K+/year in wasted fees. Savings programs work at any size. Use a specific example of a same-size merchant to prove it."},
{q:"\"Tithe.ly is working fine for our church. Why would we go through the hassle of switching giving platforms?\"",
 opts:[
 {txt:"If only 15-20% of your congregation gives online, 'working fine' is leaving money on the table. Tithe.ly's 2.9% + 30Âcost you thousands per year. Text-to-Give boosts participation and fee offset keeps that money in ministry.",ok:true},
 {txt:"Switching platforms is actually much easier than you'd think â we handle the data migration, set up your campaigns, and train your admin team. Most churches are fully transitioned within a single week.",ok:false},
...
{q:"\"Your system looks nice, but we just need a simple card reader. We don't need all those extra features â keep it simple.\"",
 opts:[
 {txt:"I hear you â let me ask though: how are you invoicing right now? Tracking appointments? Doing your books? Most merchants who want 'just a reader' are spending 5-10 hours weekly on admin that ROC Services automates.",ok:true},
 {txt:"We can absolutely start simple â our BBPOS reader is portable, affordable, and connects to your phone via Bluetooth. Once you see how it works, you'll probably want to explore the other features at your own pace.",ok:false},
 {txt:"I get it â nobody wants complexity. But the good news is ROC Services looks simple from the outside while automating the backend stuff you're doing manually. Your team won't feel any added complexity.",ok:false},
...
{q:"You have 5 leads. Which ONE do you call first?",
 context:"A) Referral from existing merchant â restaurant owner, 'interested in switching from Toast'\nB) Website form â small retailer, 'just exploring options for next quarter'\nC) Cold list target â large auto dealership, no prior contact, high processing volume\nD) Existing customer â mentioned opening a second location at their last service call\nE) Trade show lead â got your card 3 weeks ago, owns a salon, seemed interested",
 opts:[
 {txt:"A â Referral from the restaurant. Warm intro, active pain with Toast, and referrals convert 4x higher than any other lead source. This deal is closest to close right now.",ok:2,fb:"Referrals are gold. Warm intro = trust already built. Active competitor pain = urgency. This lead is furthest along the buying journey by a mile."},
 {txt:"D â Existing customer expanding. They already trust you, know the product, and adding a location is a straightforward upsell with near-certain close probability.",ok:1,fb:"Smart instinct â expansions close at 60%+. But the referral has ACTIVE pain AND a warm intro. Expansion is your #2 call, not #1."},
 {txt:"C â The auto dealership. Large processing volume means a bigger deal, higher residuals, and more impact on your monthly target than any of the smaller opportunities.",ok:0,fb:"Volume is tempting, but cold + large = longest sales cycle. No relationship, no pain signal, no urgency. You'll spend weeks on this while the referral closes for someone else."},
 {txt:"E â Trade show lead from 3 weeks ago. She showed interest and if you wait any longer the momentum will be completely gone. Strike while there's still recognition.",ok:0,fb:"3 weeks is already cold. Trade show leads convert at 2-5%. Your referral converts at 30%+. Prioritize probability over recency anxiety."}],
...
{q:"It's Day 1 in a territory with 200 cold accounts and zero pipeline. Your manager expects activity metrics AND closed revenue within 60 days. What's your plan?",
 ...
 opts:[
 {txt:"Segment the 200 by revenue potential. Attack the top 50 first â 15-20 dials per day, each with a specific value hook. Book 2-3 discovery meetings per week. Track everything in CRM daily.",ok:2,fb:"Structured, measurable, and prioritized. You're not spray-and-praying â you're hunting the biggest opportunities first with a repeatable daily cadence."},
 ...
 {txt:"Block the first two weeks for product certification and shadowing top reps. You can't sell what you don't know, and rushing into calls unprepared will burn through the account list.",ok:0,fb:"Two weeks of 'preparation' = zero pipeline. You learn faster by selling. Make calls Day 1 â you'll absorb product knowledge through real conversations."},
 ...
 bc:"Territory attack playbook: Tier accounts by opportunity â Focus top 50 â 15-20 daily dials â 2-3 meetings/week â Weekly pipeline review. Activity starts Day 1, no exceptions."},
{q:"Friday 2pm. Pipeline review is Monday morning. Four deals need attention. Which one gets your time RIGHT NOW?",
 context:"A) $2K/mo merchant â verbal 'yes' on Thursday, contract not signed yet\nB) $800/mo merchant â demo confirmed for next Wednesday, needs prep\nC) $3K/mo merchant â proposal sent 10 days ago, zero response since\nD) $500/mo merchant â signed deal, install team hasn't scheduled yet",
 opts:[
 {txt:"C â The $3K/mo ghost. Ten days of silence after a proposal is a dying deal. Call right now, resurface the value, and find out what's blocking the decision before the weekend kills it.",ok:2,fb:"Silence after a proposal is the loudest alarm in sales. Every day without follow-up increases the chance a competitor steps in or urgency fades. This was your real fire."},
 {txt:"A â Lock down the verbal yes with a signed contract before the weekend. Verbal commitments evaporate â get the signature now while the momentum is still warm from Thursday.",ok:1,fb:"Smart instinct â verbal yeses do evaporate. But A probably holds 48 hours. C has been silent for 10 DAYS and is 50% bigger. Triage by risk Ã. value."},
 {txt:"B â Use the time to deeply prep the Wednesday demo. A killer demo on an $800 deal could impress your manager, and preparation is what separates top reps from average ones.",ok:0,fb:"You have all weekend and Mon-Tues to prep for Wednesday. Meanwhile, a $3K deal is dying RIGHT NOW. Don't prepare for the future while the present bleeds."},
 {txt:"D â Chase down the install team to make sure the onboarding is smooth. A botched install creates churn, and showing your manager you protect revenue retention makes you look strategic.",ok:0,fb:"D is signed and operational â that's an ops follow-up, not a sales priority. Your job Friday afternoon is saving revenue at risk (C) and locking new revenue (A)."}],
 bc:"Pipeline triage: Silent deals at risk > Unsigned verbal commits > Future demos > Post-sale ops. Time kills ALL deals â silence after a proposal is never 'they're thinking about it.'"},
{q:"Inbound lead: \"Small coffee shop, $4K/month on Square, curious about alternatives.\" You have 30 minutes before your next outbound block. How do you handle this?",
 ...
 bc:"Qualify FAST: Why now? What's the pain? Who decides? Match your investment to the opportunity. 5-min qualify â 20-min discovery â proposal. Don't over-invest on unknowns."},
{q:"Halfway through the month: 4 closed deals at $6K monthly processing. Your target is $15K monthly. Pipeline shows 8 open deals at $22K potential. What do you do?",
 ...
 {txt:"Stay the course â you're at $6K with half the month left, which means you're roughly on pace. Keep your normal activity cadence and the pipeline will convert naturally by month-end.",ok:0,fb:"$6K at the midpoint â  on pace. Sales aren't linear â deals slip, ghost, and die. You're $2.4K short on projected. Urgency and action NOW, not 'it'll work out.'"}],
 bc:"Mid-month math: (Pipeline Ã. close rate) + closed = projected. If projected < target, you need BOTH new pipeline AND deal acceleration. Never rely on over-performing your close rate."}
];

// COMP & MARGIN IQ (answers balanced)
const COMP=[
{q:"A merchant processes $10,000/month. On Square's flat rate (2.6% + 15Â cents), roughly what do they pay annually in processing fees?",
 opts:["About $1,800 â around $150 per month","About $3,300 â roughly $275 per month","About $4,800 â almost $400 per month","About $2,400 â around $200 per month"],c:1,
 exp:"$10K Ã. 2.6% = $260/mo + per-transaction fees â $275/mo = ~$3,300/year. This is YOUR number when selling RewardPay Choice: 'I can make that $3,300 disappear.' Always do the math for them."},
{q:"You close a merchant on RewardPay Choice vs. standard processing. What happens to YOUR residual income on that deal?",
 opts:["Same residual â your comp is based on processing volume, not the pricing program the merchant is on",
 "Higher residual â cost-savings programs produce better margin per deal, and your residual is margin-weighted",
 "Lower residual â you're giving away the processing revenue the merchant would have paid, so your cut shrinks",
 "No impact on residual â residuals are calculated on a flat per-deal basis regardless of how the merchant is priced"],c:1,
...
{q:"What does the +25% V1 New Sales Margin target actually mean for how you sell?",
 opts:["Close 25% more deals than the previous rep who had your territory â it's a volume growth target",
...
{q:"A prospect wants you to drop your rate by 10 basis points on $8K/month processing. What's the annual impact on your residual income?",
 opts:["Negligible â $96/year off the merchant's bill barely affects your residual split at all",
 "Significant â 10bp across your portfolio compounds fast; that's $960/year on just this one merchant",
 ...
 "There's no direct impact â your residual is calculated before merchant discounts are applied to the rate"],c:2,
 exp:"10bp = 0.10%. $8K Ã. 0.001 = $8/mo Ã. 12 = $96/year off this ONE merchant. But 10bp across 20 merchants = ~$2,000/year in lost residuals. The real cost is the precedent: discount once, discount forever."},
{q:"Why does margin-weighted comp change how you should approach every deal?",
 opts:["It doesn't â your main focus should be closing volume because more deals = more total comp regardless of margin on individual deals",
 "It means a $3K/month deal on RewardPay Choice can pay you MORE than a $5K/month deal on discounted pricing â so selling value beats chasing volume",
...
{q:"You closed 3 deals this month. Rank them by actual residual value to YOUR paycheck:",
 opts:["Deal A ($4K/mo, 10bp discount) > C ($6K/mo, full margin) > B ($2K/mo, RewardPay) â because A is mid-size with the least discount",
 "Deal C ($6K/mo, full margin) > B ($2K/mo, RewardPay margin boost) > A ($4K/mo, 10bp discount) â full margin and RewardPay beat discounted volume",
 "Deal C ($6K/mo, full margin) > A ($4K/mo, 10bp discount) > B ($2K/mo, RewardPay) â volume matters most after margin, and B is too small",
...
{q:"When a merchant demands your lowest possible rate, which response protects both their costs AND your margin?",
 opts:["Offer interchange-plus at cost with a low monthly fee â it's transparent and merchants appreciate knowing exactly what they're paying per transaction",
 "Introduce ConsumerChoice dual pricing â the merchant's effective processing cost drops to near zero, they save more than any rate cut, and you keep full margin",
 "Match whatever their best competing quote is â winning the deal at any margin is better than losing it, because the residual stream grows over time",
 "Propose a tiered pricing model that starts low and steps up gradually over 12 months â the merchant gets an entry price and your margin improves later"],c:1,
 exp:"ConsumerChoice: merchant pays near-zero (better than ANY 'low rate'), you keep full margin. It's the only play that's a true win/win. Rate cuts are permanent â programs are differentiators."},
{q:"Why are residuals more valuable than upfront commission for long-term career earnings?",
 opts:["They aren't â upfront commission is always larger per deal and more predictable since you get paid at closing instead of waiting months",
 ...
 exp:"Residuals are the wealth engine. Each merchant adds recurring monthly income. BUT they're not guaranteed â churn matters. High-margin deals on cost-savings programs retain better AND pay more."}
];
...
{q:"Your manager reviews a lost deal and says: \"You demoed before you discovered.\" What did you do wrong?",
 ...
 {txt:"I should have sent a detailed proposal with pricing before the demo so the prospect knew exactly what they were committing to. That way the demo would have felt more purposeful.",ok:0,fb:"That's even more backwards. Discovery â Demo â Proposal. You can't propose a solution you haven't demonstrated, and you can't demo effectively without knowing their needs."},
...
{q:"Your close rate is 15% vs. team average of 28%. Your manager asks you to diagnose the problem. Where do you start?",
 ...
 {txt:"My competitive positioning. I'm probably losing deals to competitors because I'm not differentiating Payroc strongly enough â I need sharper battle cards and better competitive knowledge.",ok:0,fb:"Competitive knowledge rarely causes a 13-point close rate gap. You could know every competitor perfectly and still lose if you're pitching unqualified prospects with no urgency."},
 {txt:"My pricing strategy. I need to be more aggressive in my initial quotes and offer better upfront economics to get prospects past the decision point faster â the team probably discounts more.",ok:0,fb:"Discounting to improve close rate is a margin trap. And it's rarely the real issue. A 15% close rate means pipeline quality problems, not pricing problems."}]},
{q:"A senior rep tells you: \"Stop selling the product. Start selling the outcome.\" What does that look like for ROC Services?",
 opts:[
 {txt:"Instead of 'mobile invoicing and QuickBooks sync,' I'd say: 'Your tech finishes a job, invoices from their phone, customer pays before they leave, and it's in your books by dinner. No more chasing payments.'",ok:2,fb:"That's outcome selling. The customer sees their life CHANGING â not a list of tools. They don't buy 'mobile invoicing,' they buy 'getting paid immediately and ending the invoice chase.'"},
 {txt:"Instead of listing features, I'd bring a case study from a similar business and let the results speak for themselves â real numbers from real merchants always resonate more than a pitch.",ok:1,fb:"Case studies help, but YOU need to paint the outcome in THEIR specific context. 'A plumber like you cut his payment cycle from 14 days to same-day' â outcome + relevance."},
 {txt:"I'd shift from talking about what the product does to emphasizing Payroc's reputation, our customer satisfaction scores, and the longevity of our company. Outcomes are about trust and credibility.",ok:0,fb:"Company reputation isn't an outcome â it's a credential. Outcome selling means 'here's how your daily life gets better.' They don't care about your satisfaction score."},
 {txt:"I'd focus on the ROI calculation â show them the exact dollar savings per month, the time saved on admin, and the annual financial impact. Hard numbers make the value proposition undeniable.",ok:1,fb:"ROI helps, but outcome selling is MORE than math. It's painting a vivid picture of their new reality. 'Your tech invoices on-site, gets paid instantly, no more chasing' â that's a movie, not a spreadsheet."}]},
